                ...
                <div className="flex-1 flex-center">
                  <p className="feature-text g_text">
                    ...
                    <span className="text-white">
                      the first iphone to feature an aerospace-gadede titanium
                      design
                    </span>
                    , using the same alloy that spacecraft use for misson to
                    Mars.
                  </p>
                </div>
                <div className="flex-1 flex-center">
                  <p className="feature-text g_text">
                    ...
                    <span className="text-white">lighese pro model ever.</span>
